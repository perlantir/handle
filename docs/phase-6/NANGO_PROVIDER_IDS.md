...
| Cloudflare | 6.1 Tier 2 | `cloudflare` | `handle-dev-cloudflare` | Stage 4 rechecks forbidden patterns before writes ship |
| Vercel | 6.1 Tier 2 | `vercel` | `handle-dev-vercel` | Stage 4 rechecks provider capabilities before writes ship |
...
| Zapier | 6.1 Tier 3 | `zapier-nla` | `handle-dev-zapier` | Stage 5 verifies Zapier MCP/NLA scope before tools ship |
| Obsidian | 6.1 Tier 3 | N/A | N/A | Local-vault connector mediated by SafetyGovernor, not Nango |

## Stage 1 Notes

- Redirect URI shown in the Settings UI: `https://api.nango.dev/oauth/callback`.
